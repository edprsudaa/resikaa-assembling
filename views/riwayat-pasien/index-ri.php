...
<div class="row">
    <div class="col-lg-12">
        <div class="card card-primary card-outline">
            ...
            <?php echo $this->render('_search_rawatinap', ['model' => $searchModel]); ?>
            <br>
            <?= GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'value' => function ($model){
                            // $detail = '';
                            // $urut=1;
                            // foreach ($model->pjp as $key => $value) {
                            //     if($value->is_deleted==1){
                            //         continue;
                            //     }
                            //     $namaDpjp=HelperSpesialClass::getNamaPegawai($value->pegawai);
                            //     if ($isCariDpjp) {
                            //         $keyword = Yii::$app->request->get('LayananRjSearch')['pjp'];
                    ...
                    // [
                    //     'attribute' => 'panggil_perawat',
                    //     'label'=>'NERS',
                    //     'format' => 'raw',
                    //     'headerOptions' => ['style' => 'width: 5%;text-align: center;'],
                    //     'contentOptions' => ['style' => 'text-align: center;'],
                    //     'value' => function ($model){
                    //         return (($model->panggil_perawat==1)?'<span class="badge badge-success badge-pill">Sudah</span>':'<span class="badge badge-danger badge-pill">Belum</span>');
                    //     },
                    //     'filter' => Select2::widget([
                    //         'model' => $searchModel,
                    //         'attribute' => 'panggil_perawat',
                    ...
                    // ],
                    // [
                    //     'attribute' => 'panggil_dokter',
                    //     'label'=>'DOK',
                    //     'format' => 'raw',
                    //     'headerOptions' => ['style' => 'width: 5%;text-align: center;'],
                    //     'contentOptions' => ['style' => 'text-align: center;'],
                    //     'value' => function ($model){
                    //         return (($model->panggil_dokter==1)?'<span class="badge badge-success badge-pill">Sudah</span>':'<span class="badge badge-danger badge-pill">Belum</span>');
                    //     },
                    //     'filter' => Select2::widget([
                    //         'model' => $searchModel,
                    //         'attribute' => 'panggil_dokter',
