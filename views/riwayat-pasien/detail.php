                  ...
                  <div>
                    ...
                    <div class="timeline-item">
                      ...
                      <h3 class="timeline-header">
                        ...
                        <?= $data->fdd_tgl_terima ? ' telah menerima dokumen' : 'belum menerima dokumen' ?>
                      </h3>
                      ...
                      <div class="timeline-footer">
                        <?php if ($data->fdd_petugas_penerima_id != null && $data->fdd_tgl_terima != null) { ?>
                          ...
                          <p class="text-muted">
                            <?= $data->unitAsal->unt_nama ? $data->unitAsal->unt_nama : '-' ?>
                        ...
                        <?php if ($data->fdd_petugas_penerima_id != null && $data->fdd_tgl_terima != null && $data->fdd_tgl_kirim == null) { ?>
