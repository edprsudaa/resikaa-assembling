                     ...
                     <div class="tab-content" id="custom-tabs-four-tabContent">
                         <div class="tab-pane fade active show" id="custom-tabs-four-home" role="tabpanel" aria-labelledby="custom-tabs-four-home-tab">
                            ...
                            return data.text  
                                        ...
                                        ])->label('<label>Pegawai Pinjam : <b><span style="font-size: 12px;color: #000000;important;"><u></u></span></b></label>');
                                        ?>

                                     <?= $form->field($modelPeminjaman, 'id')->hiddenInput()->label(false) ?>
                                     <?= $form->field($modelPeminjaman, 'is_internal')->inline()->radioList(
                                            [true => 'Internal', false => 'Eksternal',]
                                     ...
                                     <?= $form->field($modelPeminjaman, 'file_upload')->fileInput() ?>
                                 ...
                                 <div class="col-md-8">
                                     ...
                                     <table class="table-list-item table table-bordered" style="width: 100%;">
                                         <thead class="thead-light" style="text-align: center;">
                                             <th style="width:100%">Daftar Rekam Medis</th>
                                         </thead>
