                                     ...
                                     <tr>
                                         ...
                                         <td style="vertical-align: top;text-align: left;">
                                             <div class="btn-group-vertical">
                                                 ...
                                                 <a class="btn btn-info btn-sm" href="<?= Url::to(['analisa-kuantitatif/detail-dokter-verifikator-edit', 'id' => $item['id'], 'registrasi_kode' => HelperGeneralClass::hashData($registrasi['kode'])]) ?>" data-id="<?= $item['id'] ?>" data-nama="<?= $item['id'] ?>"> <i class="fa fa-edit"></i></i></a>
                                             </div>
                                         </td>
                                     </tr>
                                 <?php
                             ...
                             <table>
                                 ...
                                 <?php
                                    ...
                                    ?><tr>
                                             ...
                                             <td style="vertical-align: top;text-align: left;">
                                                 <div class="btn-group-vertical">
                                                     <a class="btn btn-success btn-sm btn-preview-resume-verifikator-ri" href="<?= Url::to(['analisa-kuantitatif/preview-resume-medis', 'id' => $item['id']]) ?>" data-pasien="<?= $registrasi['pasien']['kode'] ?>" data-id="<?= $item['id'] ?>" data-nama="<?= $item['id'] ?>"> <i class="fa fa-eye"></i></i></a>
                                                     <a class="btn btn-info btn-sm" href="<?= Url::to(['dokter-verifikator-ri/verifikator-update', 'id' => $item['id'], 'registrasi_kode' => HelperGeneralClass::hashData($registrasi['kode'])]) ?>" data-id="<?= $item['id'] ?>" data-nama="<?= $item['id'] ?>"> <i class="fa fa-edit"></i></i></a>
                                                 </div>
                                             </td>
                                         </tr>
                                     <?php
                     ...
                     <div class="card-body">
                         <div class="row">
                             <div class="col-sm-12">
                                 ...
                                 <?= $form->field($model, 'id_resume_medis_ri')->hiddenInput()->label(false); ?>
                                         ...
                                         <div class="row">
                                             ...
                                             <div class="col-sm-6">
                                                 <?= $form->field($model, 'diagnosa_masuk_id')->widget(Select2::classname(), [
                                                        'initValueText' => (!$model->isNewRecord && $model->diagmasuk) ? '(' . $model->diagmasuk->kode . ')' . $model->diagmasuk->deskripsi : null,
