...
function myTable() {
  ...
  $.ajax({
    url: baseUrl+'/dokter-verifikator-ri/data-rawat-inap',
    type: 'post',
    ...
    success: function (response) {
      ...
      if(item.tgl_pulang >= '2024-03-01'){
        if(item.closing_billing_ranap_at==null){
          ...
          button_coding +='<a class=\'btn btn-sm btn-success\' target=\'_blank\' href='+baseUrl+'/dokter-verifikator-ri/view?id='+item.registrasi_kode_hash+' data-method=\'post\'><span class=\'nav-icon fas fa-edit text-white\' title=\'\' data-toggle=\'tooltip\' data-placement=\'bottom\' data-original-title=\'Coding Pelaporan\' aria-describedby=\'tooltip537870\'></span> Klik Untuk Verifikasi</a>';
        ...
        trHTML +='<tr class=\'distribusi\' ><td>'+(i+1)+'</td><td>'+item.kode+'<br>'+item.pasien_kode+'<br>'+item.nama+'</td><td>'+item.tgl_masuk+'</td><td>'+item.tgl_pulang+'</td><td>'+tgl_checkout+'</td><td>'+tgl_closing+'</td><td>'+poliList+'</td><td>'+button_coding+'</td></tr>';
