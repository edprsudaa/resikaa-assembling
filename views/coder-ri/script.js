...
$(".dynamicform_wrappers").on("afterDelete", function (e) {
  // console.log("Deleted item!");
});
...
$(".dynamicform_wrappers").on("limitReached", function (e, item) {
  alert("Limit reached");
});

// cek item item yang diganti atau tidak dan set tooltip stoknya
...
$(".dynamicform_wrappers .form-options-items").each(function (index) {
  if (index == 0) {
    $($(this).closest("tr"))
      .find(".div-icd9")
      .html("<span class='badge bg-info shadow p-2'>Tx Utama </span>");
