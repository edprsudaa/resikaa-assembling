    ...
    <div class="col-lg-12">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                echo $this->render('analisa-data-coder-claim-rj-no-verif', ['model' => $model, 'listResumeMedisVerifikator' => $listResumeMedisVerifikator, 'listResumeMedisDokter' => $listResumeMedisDokter, 'registrasi' => $registrasi]);
