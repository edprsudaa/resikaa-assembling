...
<table border="1" style="width:100%">
    <tbody>
        ...
        <tr>
            ...
            <td><?= 'TAMBAHAN 5' ?></td>
            <td><?= ($asesmen->tindakan_tambahan5_id ? $asesmen->tindlima->kode . ' (' . $asesmen->tindlima->deskripsi . ')' : '-') . '/' . ($asesmen->tindakan_tambahan5_deskripsi ? $asesmen->tindakan_tambahan5_deskripsi : '-') ?></td>
