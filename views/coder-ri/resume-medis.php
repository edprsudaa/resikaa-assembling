...
<table class="table table-sm table-form" style="border: 1px solid;">
    ...
    <tr>
        ...
        <td colspan="4" style="text-align:left"><?= ($asesmen->layanan->registrasi->debiturDetail->nama ?? '-') ?></td>
        <td colspan="2" style="text-align:left"><b>Tanggal Pulang / Ruangan Pulang :</b></td>
        <td colspan="4" style="text-align:left"><?= ($asesmen->tgl_pulang ?? '-') ?> / <?= ($asesmen->layananPulang->unit->nama ?? '') ?></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><?= 'TAMBAHAN 5' ?></td>
        <td colspan="4"><?= ($asesmen->tindakan_tambahan5_kode ? $asesmen->tindakan_tambahan5_kode : '-') . '/' . ($asesmen->tindakan_tambahan5_deskripsi ? $asesmen->tindakan_tambahan5_deskripsi : '-') ?></td>
