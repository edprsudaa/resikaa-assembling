        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                echo $this->render('claim-detail', [
                    ...
                    'listCoder' => $listCoder, 'listResumeMedisDokter' => $listResumeMedisDokter, 'listResumeMedisDokterVerifikator' => $listResumeMedisDokterVerifikator,
                    'modelCodingClaimDiagnosaDetailRi' => $modelCodingClaimDiagnosaDetailRi, 'modelCodingClaimTindakanDetailRi' => $modelCodingClaimTindakanDetailRi,  'registrasi' => $registrasi
                ]);
                ?>
            </div>
