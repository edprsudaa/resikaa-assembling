...
$('#af-CodingPelaporanRi').on('beforeSubmit',function(e){
    ...
    formData.push({name: 'CodingPelaporanRi[estimasi]', value: estimasiValue});
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="card card-primary card-outline ">
                    ...
                    <div class="card-header">
                        <h5 style="margin-bottom:6px;"><b>Coding Pelaporan</b> <a class="btn btn-danger" href="<?= Url::to(['/coder-ri/claim', 'id' => Yii::$app->request->get('id'), 'registrasi_kode' => HelperGeneralClass::hashData($registrasi['kode'])]) ?>"><i style="color: white;" class="fa fa-edit"></i> Buat Coding Klaim</a></h5>
                    </div>
                    <div class="card-body">
                        <div class="tab-content" id="custom-tabs-four-tabContent">
                            <div class="tab-pane fade active show" id="custom-tabs-four-home" role="tabpanel" aria-labelledby="custom-tabs-four-home-tab">
                                ...
                                <?php $form = ActiveForm::begin([
                                    'id' => 'af-' . $modelCodingPelaporanRi->formName(),
                                    'options' => [
                                        'name' => 'af-' . $modelCodingPelaporanRi->formName(),
                                        'data-pjax' => true
                                    ],
                                ]); ?>
                                <?= $form->field($modelCodingPelaporanRi, 'id_resume_medis_ri')->hiddenInput(['value' => Yii::$app->request->get('id')])->label(false) ?>

                                <?= $form->field($modelCodingPelaporanRi, 'registrasi_kode')->hiddenInput(['maxlength' => true, 'value' => $registrasi['kode']])->label(false) ?>
                                <?= $form->field($modelCodingPelaporanRi, 'jenis_layanan')->hiddenInput(['maxlength' => true, 'value' => 3])->label(false) ?>
                                <?= $form->field($modelCodingPelaporanRi, 'pegawai_coder_id')->hiddenInput(['maxlength' => true, 'value' => HelperSpesialClass::getUserLogin()['pegawai_id']])->label(false) ?>


                                <div class="panel-heading">
                                    <h4 class="mb-2 text-uppercase bg-light p-2"><i class="fas fa-archive mr-3"></i>I. ICD-10 Laporan (Resume id: <?= $model->id ?? '' ?> ) </h4>
                                </div>
                                <?= $form->field($modelCodingPelaporanRi, 'estimasi')->textInput(['maxlength' => true, 'type' => 'number', 'step' => '1', 'id' => 'estimasi']) ?>

                                <?= $form->field($modelCodingPelaporanRi, 'kasus', ['inputOptions' =>  ['class' => 'form-control']])->inline(true)->radioList(['0' => 'Baru', '1' => 'Lama'])->label("Jenis Kasus") ?>
                                <div class="row">
                                    <div class="col-md-12">
                                        <?php DynamicFormWidget::begin([
                                            ...
                                            'formId' => 'af-' . $modelCodingPelaporanRi->formName(),
                                            'formFields' => [
                                                'id',
                                                'icd10_id',
                                                'jumlah',
                                ...
                                <?php ActiveForm::end(); ?>
                                <?php $form = ActiveForm::begin([
                                    'id' => 'icd9-' . $modelCodingPelaporanRi->formName(),
                                    'options' => [
                                        'name' => 'icd9-' . $modelCodingPelaporanRi->formName(),
                                        'data-pjax' => true
                                    ],
                                ]); ?>
                                <?= $form->field($modelCodingPelaporanRi, 'id_resume_medis_ri')->hiddenInput(['value' => $model->id])->label(false) ?>

                                <?= $form->field($modelCodingPelaporanRi, 'registrasi_kode')->hiddenInput(['maxlength' => true, 'value' => $registrasi['kode']])->label(false) ?>
                                <?= $form->field($modelCodingPelaporanRi, 'jenis_layanan')->hiddenInput(['maxlength' => true, 'value' => 3])->label(false) ?>
                                <?php if ($modelCodingPelaporanRi->isNewRecord) { ?>
                                    <?= $form->field($modelCodingPelaporanRi, 'pegawai_coder_id')->hiddenInput(['maxlength' => true, 'value' => HelperSpesialClass::getUserLogin()['pegawai_id']])->label(false) ?>
                                <?php } else { ?>
                                    <?= $form->field($modelCodingPelaporanRi, 'pegawai_coder_id')->hiddenInput(['maxlength' => true])->label(false) ?>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <?php DynamicFormWidget::begin([
                                            ...
                                            'formId' => 'icd9-' . $modelCodingPelaporanRi->formName(),
                                            'formFields' => [
                                                'id',
                                                'icd9_id',
