                            ...
                            <table class="table table-sm" id="myTable">
                                ...
                                <tbody>
                                    ...
                                    foreach ($data as $val) {
                                        ...
                                        // break;
                                        // }
                                        $url_pilih = \yii\helpers\Url::to(['detail-mpp', 'id' => HelperGeneralClass::hashData($val['nomor_registrasi']), 'layanan_id' => $val['layanan_id'], 'layanan_nama' => $val['unit']]);
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-success btn-xs" href=<?= $url_pilih ?>><span class="nav-icon fas fa-edit text-white" title="" data-toggle="tooltip" data-placement="bottom" data-original-title="Pilih Pasien"> Catatan MPP</span></a>
                                                <a class="btn btn-danger btn-xs" href=<?= $url_mpp ?>><span class="nav-icon fas fa-edit text-white" title="" data-toggle="tooltip" data-placement="bottom" data-original-title="Pilih Pasien"> Update Resume</span></a>
