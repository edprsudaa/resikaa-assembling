    ...
    <div class="col-lg-12">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                echo $this->render('claim_detail', [
                    'model' => $model, 'modelCodingClaimMppRi' => $modelCodingClaimMppRi,
                    'modelCodingClaimMppDiagnosaDetailRi' => $modelCodingClaimMppDiagnosaDetailRi,
                    'modelCodingClaimMppTindakanDetailRi' => $modelCodingClaimMppTindakanDetailRi, 'listResumeMedis' => $listResumeMedis,  'registrasi' => $registrasi
                ]);
                ?>
            </div>
