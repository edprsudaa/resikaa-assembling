...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <?php
                echo $this->render('form_evaluasi_awal_mpp', ['model' => $model, 'listEvaluasiAwalMpp' => $listEvaluasiAwalMpp, 'listSkriningPasienMpp' => $listSkriningPasienMpp, 'listMpp' => $listMpp, 'registrasi' => $registrasi]);
                ?>
            </div>
