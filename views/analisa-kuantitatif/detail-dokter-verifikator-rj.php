    ...
    <div class="col-lg-12">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                echo $this->render('analisa-data-dokter-verifikator-rj', ['model' => $model, 'listResumeMedisVerifikator' => $listResumeMedisVerifikator, 'listResumeMedisDokter' => $listResumeMedisDokter, 'registrasi' => $registrasi]);
