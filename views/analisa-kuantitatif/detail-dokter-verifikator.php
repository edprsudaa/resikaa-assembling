    ...
    <div class="col-lg-12">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                echo $this->render('analisa-data-dokter-verifikator', ['model' => $model, 'listResumeMedisVerifikator' => $listResumeMedisVerifikator, 'listResumeMedisDokter' => $listResumeMedisDokter, 'registrasi' => $registrasi]);
