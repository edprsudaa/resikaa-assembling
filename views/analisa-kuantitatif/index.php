...
<div class="row">
    <div class="col-lg-12">
        ...
        <?php
        // $form = ActiveForm::begin(['id' => 'analisa-dokumen', 'action' => 'javascript::void(0)', 'options' => ['class' => 'form form-catatan', 'role' => 'form']]);
        ?>
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <iframe width="100%" style="height:1000px" id="iframe-0" src="http://emr-pengolahan-data.simrs.aa/history-pasien/detail-kunjungan?rm=<?= $registrasi['pasien_kode'] ?>&noreg=<?= $registrasi['kode'] ?>">
