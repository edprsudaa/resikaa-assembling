...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="card">
                    <a type="button" href=http://emr-pengolahan-data.simrs.aa/history-pasien/list-kunjungan-object?id=<?= HelperGeneralClass::hashData($registrasi['pasien_kode']) ?>&versi=1 href="#custom-tabs-two-0" role="tab" aria-controls="custom-tabs-two-0" aria-selected="false" target="_blank" class="btn btn-block bg-gradient-warning btn-lg">Lihat Riwayat Pasien Berdasar Dokumen</a>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="card">
                    <a type="button" href=http://emr-pengolahan-data.simrs.aa/history-pasien/list-kunjungan?id=<?= HelperGeneralClass::hashData($registrasi['pasien_kode']) ?>&versi=1 href="#custom-tabs-two-0" role="tab" aria-controls="custom-tabs-two-0" aria-selected="false" target="_blank" class="btn btn-block bg-gradient-success btn-lg">Lihat Riwayat Pasien Berdasar Registrasi</a>

                </div>
            </div>
            <div class="col-lg-4">
                <div class="card">
                    <a type="button" href=http://emr-pengolahan-data.simrs.aa/history-pasien/detail-kunjungan?rm=<?= $registrasi['pasien_kode'] ?>&noreg=<?= $registrasi['kode'] ?> href="#custom-tabs-two-0" role="tab" aria-controls="custom-tabs-two-0" aria-selected="false" target="_blank" class="btn btn-block bg-gradient-primary btn-lg">Lihat Riwayat Pasien Berdasar Registrasi Hari Ini</a>
            ...
            <div class="col-lg-12">
                ...
                echo $this->render('analisa-data-dokter-verifikator-update', ['model' => $model, 'listResumeMedisVerifikator' => $listResumeMedisVerifikator, 'listResumeMedisDokter' => $listResumeMedisDokter, 'registrasi' => $registrasi]);
