                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php } else { ?>
                                                            <a class="btn btn-success btn-sm" target="_blank" href="http://bedah-sentral.simrs.aa/cetak/cetak-intra-operasi?intra_id=<?= HelperGeneralClass::hashData($item['iop_id']) ?>" data-id="<?= $item['iop_id']
