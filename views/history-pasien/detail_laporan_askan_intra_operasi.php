...
$this->title = 'ASKAN INTRA OPERASI';
                        ...
                        <div class="col-md-12">
                            <div class="card card-info">
                                <div class="card-header">
                                    <h3 class="card-title">LAPORAN ASESMEN KEPERAWATAN INTRA OPERASI</h3>
                                ...
                                <div class="card-body">
                                    <table class="table table-striped table-bordered " style="text-align: justify;">
                                        ...
                                        <?php
                                        if (!empty($listIntraOperasiPerawat)) {
                                            $i = 1;
                                            foreach ($listIntraOperasiPerawat  as $item) {
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td><a class="btn btn-success btn-sm" target="_blank" href="http://bedah-sentral.simrs.aa/cetak/cetak-intra-operasi?intra_id=<?= HelperGeneralClass::hashData($item['iop_id']) ?>" data-id="<?= $item['iop_id']
                                                                                                                                                                                                                                                ?>" data-nama="<?= $item['iop_id']
