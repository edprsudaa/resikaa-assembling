                        ...
                        <div class="col-md-12">
                            <div class="card card-info">
                                <div class="card-header">
                                    <h3 class="card-title">RESEP DOKTER</h3>
                                    ...
                                    <table class="table table-striped table-bordered " style="text-align: justify;">
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td> <a href="#" class="btn btn-sm btn-flat btn-obat-terjual <?php echo $r['is_deleted'] == 0 ? 'btn-success' : 'btn-danger' ?>" data-id="<?= HelperGeneralClass::hashData($r['id_penjualan']); ?>">
