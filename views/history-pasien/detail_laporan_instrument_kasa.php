...
$this->title = 'INSTRUMENT KASA OPERASI';
                        ...
                        <div class="col-md-12">
                            <div class="card card-info">
                                <div class="card-header">
                                    <h3 class="card-title">LAPORAN INSTRUMENT KASA OPERASI</h3>
                                ...
                                <div class="card-body">
                                    <table class="table table-striped table-bordered " style="text-align: justify;">
                                        ...
                                        <?php
                                        if (!empty($listInstrumentKasa)) {
                                            $i = 1;
                                            foreach ($listInstrumentKasa  as $item) {
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td><a class="btn btn-success btn-sm" target="_blank" href="http://bedah-sentral.simrs.aa/cetak/cetak-jumlah-kasa?pjki_id=<?= HelperGeneralClass::hashData($item['pjki_id']) ?>" data-id="<?= $item['pjki_id']
                                                                                                                                                                                                                                                ?>" data-nama="<?= $item['pjki_id']
