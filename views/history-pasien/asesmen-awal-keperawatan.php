...
<div style="<?= $style ?>">
    <h2>Asesmen Awal Keperawatan General</h2>
    <table class="table table-sm table-form" style="border: 2px solid;">
        ...
        <tr>
            <th class="bg-lightblue" colspan="12" style="text-align:left">III. PEMERIKSAAN ANTROPOMETRI</th>
        </tr>
        <tr>
        ...
        <tr>
            <th class="text-left bg-lightblue" colspan="6" style="text-align:left">IV. PEMERIKSAAN KULIT & KELAMIN</th>
            <th class="text-left bg-lightblue" colspan="6" style="text-align:left">V. PEMERIKSAAN KEPALA & LEHER</th>
        </tr>
        <tr>
        ...
        <tr>
            <th class="text-left bg-lightblue" colspan="6" style="text-align:left">VI. PEMERIKSAAN RESPIRASI</th>
            <th class="text-left bg-lightblue" colspan="6" style="text-align:left">VII. PEMERIKSAAN KARDIOVASKULER</th>
        </tr>
        <tr>
        ...
        <tr>
            <th class="text-left bg-lightblue" colspan="6" style="text-align:left">VIII. PEMERIKSAAN PERSEPSI SENSORI</th>
            <th class="text-left bg-lightblue" colspan="6" style="text-align:left">IX. PEMERIKSAAN NEUROLOGIS</th>
        </tr>
        <tr>
        ...
        <tr>
            <th class="text-left bg-lightblue" colspan="6" style="text-align:left">X. PEMERIKSAAN ELIMINASI</th>
            <th class="text-left bg-lightblue" colspan="6" style="text-align:left">XI. PEMERIKSAAN GENETALIA</th>
        </tr>
        <tr>
        ...
        <tr>
            <th class="text-left bg-lightblue" colspan="6" style="text-align:left">XII. PEMERIKSAAN GASTROINTESTINAL</th>
            <th class="text-left bg-lightblue" colspan="6" style="text-align:left">XIII. PEMERIKSAAN EXTREMITAS</th>
        </tr>
        <tr>
        ...
        <tr>
            <th class="text-left bg-lightblue" colspan="12" style="text-align:left">XIV. PERTUMBUHAN & PERKEMBANGAN</th>
        </tr>
        <tr>
        ...
        <tr>
            <th class="text-left bg-lightblue" colspan="12" style="text-align:left">XV. KEBUTUHAN KOMUNIKASI EDUKASI</th>
        </tr>
        <tr>
        ...
        <tr>
            <th class="text-left bg-lightblue" colspan="12" style="text-align:left">XVI. PERENCANAAN PASIEN PULANG</th>
        </tr>
        <tr>
