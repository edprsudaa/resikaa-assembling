                        ...
                        <div class="col-md-12">
                            <div class="card card-info">
                                <div class="card-header">
                                    <h3 class="card-title">RESUME RAWAT JALAN</h3>
                                    ...
                                    <table class="table table-striped table-bordered " style="text-align: justify;">
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td><a class="btn <?php echo $item->is_deleted == 0 ? 'btn-success' : 'btn-danger' ?> btn-sm btn-sm btn-preview-resume-rj" data-id="<?= HelperGeneralClass::hashData($item->id)
                                                                                                                                                                                        ?>" data-nama="<?= $item->id
                                                                                                                                                                                                        ?>">Klik untuk lihat</a>
