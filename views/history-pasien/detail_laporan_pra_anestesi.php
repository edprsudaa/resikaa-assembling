...
$this->title = 'LAPORAN PRA ANESTESI';
                        ...
                        <div class="col-md-12">
                            <div class="card card-info">
                                <div class="card-header">
                                    <h3 class="card-title">LAPORAN PRA ANESTESI</h3>
                                    ...
                                    <table class="table table-striped table-bordered " style="text-align: justify;">
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td><a class="btn btn-success btn-sm" target="_blank" href="http://bedah-sentral.simrs.aa/cetak/cetak-pra-anestesi?ppa_id=<?= HelperGeneralClass::hashData($item['ppa_id']) ?>" data-id="<?= $item['ppa_id']
