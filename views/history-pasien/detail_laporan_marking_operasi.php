                            ...
                            <div class="card card-info">
                                ...
                                <div class="card-body">
                                    <table class="table table-striped table-bordered " style="text-align: justify;">
                                        ...
                                        <?php
                                        if (!empty($listMarkingOperasi)) {
                                            $i = 1;
                                            foreach ($listMarkingOperasi as $item) {
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td><a class="btn btn-success btn-sm" target="_blank" href="http://bedah-sentral.simrs.aa/cetak/cetak-marking?marking_id=<?= HelperGeneralClass::hashData($item['mlo_id']) ?>" data-id="<?= $item['mlo_id']
                                                                                                                                                                                                                                            ?>" data-nama="<?= $item['mlo_id']
