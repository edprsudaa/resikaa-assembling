...
<table class="table table-sm table-form" style="border: 1px solid;">
    ...
    <tr>
        <td><?= 'UTAMA' ?></td>
        <td colspan="4"><?= ($asesmen->diagnosa_utama_kode!=NULL || $asesmen->diagnosa_utama_deskripsi!=NULL) ? $asesmen->diagnosa_utama_kode . '/' . $asesmen->diagnosa_utama_deskripsi : '-' ?></td>
        <td><?= 'UTAMA' ?></td>
        <td colspan="4"><?= ($asesmen->tindakan_utama_kode!=NULL || $asesmen->tindakan_utama_deskripsi) ? $asesmen->tindakan_utama_kode . '/' . $asesmen->tindakan_utama_deskripsi : '-' ?></td>

    </tr>
    <tr>
        <td><?= 'TAMBAHAN 1' ?></td>
        <td colspan="4"><?= ($asesmen->diagnosa_tambahan1_kode!=NULL || $asesmen->diagnosa_tambahan1_deskripsi) ? $asesmen->diagnosa_tambahan1_kode . '/' . $asesmen->diagnosa_tambahan1_deskripsi : '-' ?></td>
        <td><?= 'TAMBAHAN 1' ?></td>
        <td colspan="4"><?= ($asesmen->tindakan_tambahan1_kode!=NULL || $asesmen->tindakan_tambahan1_deskripsi) ? $asesmen->tindakan_tambahan1_kode . '/' . $asesmen->tindakan_tambahan1_deskripsi : '-' ?></td>

    </tr>
    <tr>
        <td><?= 'TAMBAHAN 2' ?></td>
        <td colspan="4"><?= ($asesmen->diagnosa_tambahan2_kode!=NULL || $asesmen->diagnosa_tambahan2_deskripsi!=NULL) ? $asesmen->diagnosa_tambahan2_kode . '/' . $asesmen->diagnosa_tambahan2_deskripsi : '-' ?></td>
        <td><?= 'TAMBAHAN 2' ?></td>
        <td colspan="4"><?= ($asesmen->tindakan_tambahan2_kode!=NULL || $asesmen->tindakan_tambahan2_deskripsi!=NULL) ? $asesmen->tindakan_tambahan2_kode . '/' . $asesmen->tindakan_tambahan2_deskripsi : '-' ?></td>

    </tr>
    <tr>
        <td><?= 'TAMBAHAN 3' ?></td>
        <td colspan="4"><?= ($asesmen->diagnosa_tambahan3_kode!=NULL || $asesmen->diagnosa_tambahan3_deskripsi!=NULL ) ? $asesmen->diagnosa_tambahan3_kode . '/' . $asesmen->diagnosa_tambahan3_deskripsi : '-' ?></td>
        <td><?= 'TAMBAHAN 3' ?></td>
        <td colspan="4"><?= ($asesmen->tindakan_tambahan3_kode!=NULL || $asesmen->tindakan_tambahan3_deskripsi!=NULL) ? $asesmen->tindakan_tambahan3_kode . '/' . $asesmen->tindakan_tambahan3_deskripsi : '-' ?></td>

    </tr>
    <tr>
        <td><?= 'TAMBAHAN 4' ?></td>
        <td colspan="4"><?= ($asesmen->diagnosa_tambahan4_kode!=NULL || $asesmen->diagnosa_tambahan4_deskripsi!=NULL) ? $asesmen->diagnosa_tambahan4_kode . '/' . $asesmen->diagnosa_tambahan4_deskripsi : '-' ?></td>
        <td><?= 'TAMBAHAN 4' ?></td>
        <td colspan="4"><?= ($asesmen->tindakan_tambahan4_kode!=NULL || $asesmen->tindakan_tambahan4_deskripsi!=NULL) ? $asesmen->tindakan_tambahan4_kode . '/' . $asesmen->tindakan_tambahan4_deskripsi : '-' ?></td>

    </tr>
    <tr>
        <td><?= 'TAMBAHAN 5' ?></td>
        <td colspan="4"><?= ($asesmen->diagnosa_tambahan5_kode!=NULL || $asesmen->diagnosa_tambahan5_deskripsi!=NULL) ? $asesmen->diagnosa_tambahan5_kode . '/' . $asesmen->diagnosa_tambahan5_deskripsi : '-' ?></td>
        <td><?= 'TAMBAHAN 5' ?></td>
        <td colspan="4"><?= ($asesmen->tindakan_tambahan5_kode!=NULL || $asesmen->tindakan_tambahan5_deskripsi!=NULL) ? $asesmen->tindakan_tambahan5_kode . '/' . $asesmen->tindakan_tambahan5_deskripsi : '-' ?></td>
