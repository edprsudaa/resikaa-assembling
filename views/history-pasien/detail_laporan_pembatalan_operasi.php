                            ...
                            <div class="card card-info">
                                ...
                                <div class="card-body">
                                    <table class="table table-striped table-bordered " style="text-align: justify;">
                                        ...
                                        <?php
                                        if (!empty($listPembatalanOperasi)) {
                                            $i = 1;
                                            foreach ($listPembatalanOperasi as $item) {
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td><a class="btn btn-success btn-sm" target="_blank" href="http://bedah-sentral.simrs.aa/cetak/cetak-pembatalan-operasi?id=<?= HelperGeneralClass::hashData($item['bat_id']) ?>" data-id="<?= $item['bat_id']
                                                                                                                                                                                                                                                ?>" data-nama="<?= $item['bat_id']
