...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <?php
                echo $this->render('analisa-data-coder-claim-edit-rj-no-verif', ['model' => $model, 'listResumeMedisVerifikator' => $listResumeMedisVerifikator, 'listResumeMedisDokter' => $listResumeMedisDokter, 'registrasi' => $registrasi]);
                ?>
            </div>
