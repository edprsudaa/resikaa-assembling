                            ...
                            ?>
                                 ...
                                 <div colspan="3" class="border border-top-0 border-info" style="padding-left: 4px;">
                                     <div class="btn-group">
                                         ...
                                         <a class="btn btn-info btn-sm" href="<?= Url::to(['/analisa-kuantitatif/detail-mpp-edit-resume', 'id' => $item['id'], 'registrasi_kode' => HelperGeneralClass::hashData($registrasi['kode'])]) ?>" data-id="<?= $item['id'] ?>" data-nama="<?= $item['id'] ?>"> <i class="fa fa-edit"></i></i></a>
                                     </div>
                                 </div>
                             ...
                             <div class="col-sm-12">
                                 ...
                                 <!-- <div class="row">
                                     ...
                                     <div class="col-sm-10">
                                         <div class="row">
                                             <div class="col-sm-6">
                                                 <?php // $form->field($model, "diagnosa_masuk_deskripsi")->textInput(['placeholder' => 'Diagnosa Masuk'])->label(false) 
                                                    ?>
                                             </div>
                                             <div class="col-sm-6">
                                                 <?php
                                 ...
                                 <!-- <div class="row">
                                     ...
                                     <div class="col-sm-10">
                                         <div class="row">
                                             <div class="col-sm-6">
                                                 <?php // $form->field($model, "diagnosa_utama_deskripsi")->textInput(['placeholder' => 'Diagnosa Utama'])->label(false) 
                                                    ?>
                                             </div> -->
                                 <!-- <div class="col-sm-6"> -->
                                 <?php // $form->field($model, 'diagnosa_utama_id')->widget(Select2::classname(), [
                                 ...
                                 <!-- </div>
                             <div class="col-sm-6"> -->
                                 <?php // $form->field($model, 'tindakan_utama_id')->widget(Select2::classname(), [
