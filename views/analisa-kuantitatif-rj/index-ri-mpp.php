...
<div class="row">
    <div class="col-lg-12">
        <div class="card card-primary card-outline">
            ...
            ?>
            <?php echo $this->render('_search_rawatinap_mpp', ['model' => $searchModel]); ?>
            <br>
            <?= GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'filter' => Select2::widget([
                            'model' => $searchModel,
                            'attribute' => 'unit_kode',
                            'data' => HelperSpesialClass::getListRIAksesPegawai()['unit_akses'],
                    ...
                    [
                        ...
                        'urlCreator' => function ($action, $model, $key, $index) {
                            if ($action === 'pilih') {
                                $url = \yii\helpers\Url::to(['/analisa-kuantitatif/detail-mpp', 'id' => HelperGeneralClass::hashData($model->registrasi_kode),'layanan_id' => $model->id,'layanan_nama'=>($model->unit)?$model->unit->nama:'']);
                                return $url;
                            }
                            if ($action === 'resume_ri') {
