    ...
    <div class="col-lg-12">
        <div class="card card-primary card-outline">
            <div class="card-body">
                ...
                <?php echo $this->render('_search_rawatjalan_new_verifikator', ['model' => $searchModel]); ?>
                <br>
                <?= GridView::widget([
                    ...
                    'columns' => [
                        ...
                        [
                            'label' => 'Status Verifikator',
                            'format' => 'html',
                            'headerOptions' => ['style' => 'width: 4%;text-align: center;color:#6658dd;'],
                            'value' => function ($model) {
                                if ($model['verifikator']) {
                                    return '<span class="badge bg-success">Sudah Verifikasi</span><br><span class="badge bg-info">' . $model['verifikator']  . '</span>';
                                } else {
                        ...
                        [
                            ...
                            'urlCreator' => function ($action, $model, $key, $index) {
                                ...
                                if ($action === 'icd') {
                                    $url = \yii\helpers\Url::to(['/analisa-kuantitatif/detail-dokter-verifikator-rj', 'id' => HelperGeneralClass::hashData($model['kode']), 'icd' => true]);
                                    return $url;
                                }
                                if ($action === 'coder') {
