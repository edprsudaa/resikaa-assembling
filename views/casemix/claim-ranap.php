            ...
            <tbody>
                <?php foreach ($data as  $item): ?>
                    <tr>
                        ...
                        <td>
                            <ul>
                                <?php foreach ($item->claimDiagnosa as $index => $itemDiagnosa) { ?>
                        ...
                        <td>
                            <ul>
                                <?php foreach ($item->claimTindakan as $index => $itemTindakan) { ?>
    ...
    <?php else: ?>
        ...
        <div class="form-group">
            <?= Html::button('Simpan', [
                ...
                'id' => 'claim-simpan',
                'data-url' => Url::to(['/casemix/update-estimasi-ranap']) // Sesuaikan dengan URL yang diinginkan
            ]) ?>
