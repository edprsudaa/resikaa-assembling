...
function myTable() {
  ...
  $.ajax({
    url: baseUrl+'/casemix/data-rawat-jalan',
    type: 'post',
  ...
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Claim BPJS Rawat Jalan</h5>
...
<script>
  function updateClaim(id) {
    ...
    $.ajax({
      url: '<?= Url::to(['/casemix/claim-rajal']) ?>', // URL endpoint untuk mengambil data log
      type: 'GET',
      data: {
        id: id
      ...
      success: function(response) {
        ...
        $('#claim-simpan').on('click', function(e) {
          e.preventDefault();
          // Serialize form data
          var form = $('#claim-CodingClaimRj'); // ID dari form
