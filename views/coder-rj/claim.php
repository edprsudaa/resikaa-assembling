        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                echo $this->render('claim-detail', [
                    ...
                    'listCoder' => $listCoder, 'listResumeMedisDokter' => $listResumeMedisDokter,
                    'modelCodingClaimDiagnosaDetailRj' => $modelCodingClaimDiagnosaDetailRj, 'modelCodingClaimTindakanDetailRj' => $modelCodingClaimTindakanDetailRj,  'registrasi' => $registrasi
                ]);
                ?>
            </div>
