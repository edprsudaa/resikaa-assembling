...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="row">
            <div class="col-lg-9">
                <?php
                echo $this->render('analisa-data-dokter-verifikator-rj-update', ['model' => $model, 'listResumeMedisVerifikator' => $listResumeMedisVerifikator, 'listResumeMedisDokter' => $listResumeMedisDokter, 'registrasi' => $registrasi]);
                ?>
            </div>
            <div class="col-lg-3">
