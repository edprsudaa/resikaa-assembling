 <?php
    ...
    $this->registerJs("
    $('#codingclaim-CodingClaimRj').on('beforeSubmit',function(e){
        ...
        //var count = 0;
        //$('#codingclaim-CodingClaimRj select[name$=\'[utama]\']').each(function() {
            //if ($(this).val() == '1') {
                //count++;
            //}
        //});
    ...
    $('#codingclaimic9-CodingClaimRj').on('beforeSubmit',function(e){
        e.preventDefault();
         ...
         <div class="row">
                     ...
                     <div class="card-body">
                         ...
                         <table>
                             ...
                             <?php
                                ...
                                ?><tr>
                                     <td>
                                         <div class="border border-info bg-danger" style="border: 1px solid #e1e1e1fa;padding-left: 4px;"><b>Nama Dokter : </b><?= HelperSpesialClass::getNamaPegawaiArray($listCoder->resumeMedis->dokter) ?? '' ?><br>(Resume id: <?= $listCoder->id_resume_medis_rj ?? '' ?>)</div>
             ...
             <div class="col-lg-8">
                 ...
                 <div class="card card-primary card-outline">
                     ...
                     <div class="card-header">
                         <h5 style="margin-bottom:6px;">Coding Claim (Coder Claim id:<?= Yii::$app->request->get('id') ?? '' ?>) <a class="btn btn-danger" href="<?= Url::to(['/coder-rj/pelaporan', 'id' => Yii::$app->request->get('id'), 'registrasi_kode' => HelperGeneralClass::hashData($registrasi['kode']), 'icd' => true]) ?>"><i style="color: white;" class="fa fa-edit"></i> Buat Coding Pelaporan</a></h5>
                     </div>
                     <div class="card-body">
                         <div class="tab-content" id="custom-tabs-four-tabContent">
                             <div class="tab-pane fade active show" id="custom-tabs-four-home" role="tabpanel" aria-labelledby="custom-tabs-four-home-tab">
                                 ...
                                 <?php $form = ActiveForm::begin([
                                        'id' => 'codingclaim-' . $modelCodingClaimRj->formName(),
                                        'options' => [
                                            'name' => 'codingclaim-' . $modelCodingClaimRj->formName(),
                                            'data-pjax' => true
                                        ],
                                    ]); ?>
                                 <?= $form->field($modelCodingClaimRj, 'id_resume_medis_rj')->hiddenInput(['value' => Yii::$app->request->get('id')])->label(false) ?>

                                 <?= $form->field($modelCodingClaimRj, 'registrasi_kode')->hiddenInput(['maxlength' => true, 'value' => $registrasi['kode']])->label(false) ?>
                                 <?= $form->field($modelCodingClaimRj, 'jenis_layanan')->hiddenInput(['maxlength' => true, 'value' => 2])->label(false) ?>
                                 <?php if ($modelCodingClaimRj->isNewRecord) { ?>
                                     <?= $form->field($modelCodingClaimRj, 'pegawai_coder_id')->hiddenInput(['maxlength' => true, 'value' => HelperSpesialClass::getUserLogin()['pegawai_id']])->label(false) ?>
                                 <?php } else { ?>
                                     <?= $form->field($modelCodingClaimRj, 'pegawai_coder_id')->hiddenInput(['maxlength' => true])->label(false) ?>

                                 <?php } ?>
                                 <div class="panel-heading">
                                     <h6 class="mb-2 text-uppercase bg-light p-2"><i class="fas fa-archive mr-3"></i>I. ICD-10 Claim (Resume id: <?= $model->id ?? '' ?> ) </h6>
                                 </div>
                                 <?= $form->field($modelCodingClaimRj, 'estimasi')->textInput(['maxlength' => true, 'type' => 'number', 'step' => '1', 'id' => 'estimasi']) ?>

                                 <?= $form->field($modelCodingClaimRj, 'kasus', ['inputOptions' =>  ['class' => 'form-control']])->inline(true)->radioList(['0' => 'Baru', '1' => 'Lama'])->label("Jenis Kasus") ?>
                                 <div class="row">
                                     <div class="col-md-12">
                                         <?php DynamicFormWidget::begin([
                                                ...
                                                'model' => $modelCodingClaimDiagnosaDetailRj[0],
                                                'formId' => 'codingclaim-' . $modelCodingClaimRj->formName(),
                                                'formFields' => [
                                                    'id',
                                                    'icd10_id',
                                                    'jumlah',
                                         ...
                                         <table class="table-list-item table table-bordered" style="width: 100%;">
                                             ...
                                             <tbody class="form-options-body">
                                                 ...
                                                 <?php foreach ($modelCodingClaimDiagnosaDetailRj as $i => $modelDetail) : ?>
                                 ...
                                 <?php ActiveForm::end(); ?>
                                 <?php $form = ActiveForm::begin([
                                        'id' => 'codingclaimic9-' . $modelCodingClaimRj->formName(),
                                        'options' => [
                                            'name' => 'codingclaimic9-' . $modelCodingClaimRj->formName(),
                                            'data-pjax' => true
                                        ],
                                    ]); ?>
                                 <?= $form->field($modelCodingClaimRj, 'id_resume_medis_rj')->hiddenInput(['value' => Yii::$app->request->get('id')])->label(false) ?>
                                 ...
                                 <div class="row">
                                     <div class="col-md-12">
                                         <?php DynamicFormWidget::begin([
                                                ...
                                                'model' => $modelCodingClaimTindakanDetailRj[0],
                                                'formId' => 'codingclaimic9-' . $modelCodingClaimRj->formName(),
                                                'formFields' => [
                                                    'id',
                                                    'icd9_id',
                                         ...
                                         <table class="table-list-item table table-bordered table-responsive" style="width: 100%;">
                                             ...
                                             <tbody class="form-options-bodys">
                                                 ...
                                                 <?php foreach ($modelCodingClaimTindakanDetailRj as $i => $modelDetail) : ?>
