         ...
         <div class="row">
             ...
             <div class="col-lg-8">
                 ...
                 <div class="card card-primary card-outline">
                     ...
                     <div class="card-header">
                         <h5 style="margin-bottom:6px;">Coding Claim <a class="btn btn-danger" href="<?= Url::to(['/analisa-kuantitatif/detail-coder-pelaporan', 'id' => HelperGeneralClass::hashData($registrasi['kode']), 'icd' => true]) ?>"><i style="color: white;" class="fa fa-edit"></i> Buat Coding Pelaporan</a></h5>
                     </div>
                     <div class="card-body">
                         <div class="row">
                             <div class="col-sm-12">
