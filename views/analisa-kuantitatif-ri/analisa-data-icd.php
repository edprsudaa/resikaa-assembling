    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="card card-primary card-outline">
                    <div class="card-header">
                        <h5 style="margin-bottom:6px;">Coding Pelaporan </h5>
                    </div>
                    <div class="card-body">
                        <div class="tab-content" id="custom-tabs-four-tabContent">
                            <div class="tab-pane fade active show" id="custom-tabs-four-home" role="tabpanel" aria-labelledby="custom-tabs-four-home-tab">
                                ...
                                <?= $form->field($modelCustomer, 'registrasi_kode')->hiddenInput(['value' => $registrasi['kode']])->label(false) ?>
                                <?= $form->field($modelCustomer, 'jenis_layanan')->hiddenInput(['value' => 3])->label(false) ?>
                                <?= $form->field($modelCustomer, 'pegawai_coder_id')->hiddenInput(['value' => HelperSpesialClass::getUserLogin()['pegawai_id']])->label(false) ?>

                                <div class="panel-heading">
                                    <h6 class="mb-2 text-uppercase bg-light p-2"><i class="fas fa-archive mr-3"></i>I. ICD-10 Laporan </h6>
                                </div>
                                ...
                                <div class="panel-heading">
                                    <h6 class="mb-2 text-uppercase bg-light p-2"><i class="fas fa-archive mr-3"></i>II. ICD-9 Laporan </h6>
                                </div>
