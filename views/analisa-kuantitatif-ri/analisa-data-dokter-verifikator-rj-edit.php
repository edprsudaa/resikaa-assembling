 <?php
    ...
    $this->registerJs("
    $('.btn-lihat-verifikator-rj').on('click', function (){
    ...
    $('#ResumeMedisRj_keterangan_2_t').on('keyup input change focus paste', function (e) {
     ...
     $('#af-resume-medis-rj-verifikator').on('beforeSubmit',function(e){
         e.preventDefault();
         var btn=$('.btn-submit');
         var htm=btn.html();
         ...
         <div class="row">
             <div class="col-lg-5">
                 <div class="card card-primary card-outline">
                     ...
                     <div class="card-body">
                         <?php foreach ($listResumeMedisDokter as $item)
                            ?>
                         <div class="border border-info bg-info" style="border: 1px solid #e1e1e1fa;padding-left: 4px;">Nama Dokter : <?= HelperSpesialClass::getNamaPegawaiArray($item->dokter) ?? '' ?> <br>(ID Resume : <?= $item->id ?? '' ?>)</div>
                 ...
                 <div class="card card-primary card-outline">
                     ...
                     <div class="card-body">
                         <?php
                            //  print_r($listResumeMedisVerifikator);
                            //  die;
                            ...
                            ?>
                             ...
                             <div colspan="3" class="border border-top-0 border-info" style="padding-left: 4px;"></div>
             ...
             <div class="col-lg-7">
                 ...
                 <div class="card card-primary card-outline">
                     <div class="card-header">
                         ...
                         <h5 style="margin-bottom:6px;">Resume Medis Rawat Inap Dokter DPJP (Resume id : <?= $model->id_resume_medis_rj ?? '' ?>) </h5>
                     </div>
                     <div class="card-body">
                         <div class="row">
                             <div class="col-sm-12">
                                 <?php $form = ActiveForm::begin([
                                        'id' => 'af-resume-medis-rj-verifikator',
                                    ]); ?>
                                 <?= $form->field($model, 'id_resume_medis_rj')->hiddenInput(['value' => $_GET['id']])->label(false); ?>
