 <?php
    ...
    $('#codingclaim-CodingClaimRj').on('beforeSubmit',function(e){
        ...
        $.ajax({
            url:'" . Url::to(['coding-claim-rj-icd-10-save']) . "',
            type:'post',
            dataType:'json',
            data:$(this).serialize(),
    ...
    $('#codingclaimic9-CodingClaimRj').on('beforeSubmit',function(e){
        ...
        // Cek jumlah opsi yang dipilih dengan nilai \'Yes\' pada field select2 \'utama\'
        var count = 0;
        $('#codingclaimic9-CodingClaimRj select[name$=\'[utama]\']').each(function() {
            if ($(this).val() == '1') {
                count++;
            }
        });
        ...
        $.ajax({
            url:'" . Url::to(['coding-claim-rj-icd-9-save']) . "',
            type:'post',
            dataType:'json',
            data:$(this).serialize(),
            success:function(result){
         ...
         <div class="row">
             ...
             <div class="col-lg-8">
                 ...
                 <div class="card card-primary card-outline">
                     ...
                     <div class="card-header">
                         <h5 style="margin-bottom:6px;">Coding Claim (Coder Claim id:<?= $model->id_resume_medis_rj ?? '' ?>) <a class="btn btn-danger" href="<?= Url::to(['/analisa-kuantitatif/detail-coder-pelaporan-rj', 'id' => HelperGeneralClass::hashData($registrasi['kode']), 'icd' => true]) ?>"><i style="color: white;" class="fa fa-edit"></i> Buat Coding Pelaporan</a></h5>
                     </div>
                     <div class="card-body">
                         <div class="tab-content" id="custom-tabs-four-tabContent">
                             <div class="tab-pane fade active show" id="custom-tabs-four-home" role="tabpanel" aria-labelledby="custom-tabs-four-home-tab">
                                 ...
                                 <?php $form = ActiveForm::begin([
                                        'id' => 'codingclaim-' . $modelCustomer->formName(),
                                        'options' => [
                                            'name' => 'codingclaim-' . $modelCustomer->formName(),
                                            'data-pjax' => true
                                        ],
                                    ]); ?>
                                 <?= $form->field($modelCustomer, 'id_resume_medis_rj')->hiddenInput(['value' => $model->id_resume_medis_rj])->label(false) ?>
                                 ...
                                 <div class="row">
                                     <div class="col-md-12">
                                         <?php DynamicFormWidget::begin([
                                                ...
                                                'formId' => 'codingclaim-' . $modelCustomer->formName(),
                                                'formFields' => [
                                                    'id',
                                                    'icd10_id',
                                                    'jumlah',
                                 ...
                                 <?php ActiveForm::end(); ?>
                                 <?php $form = ActiveForm::begin([
                                        'id' => 'codingclaimic9-' . $modelCustomer->formName(),
                                        'options' => [
                                            'name' => 'codingclaimic9-' . $modelCustomer->formName(),
                                            'data-pjax' => true
                                        ],
                                    ]); ?>
                                 <?= $form->field($modelCustomer, 'id_resume_medis_rj')->hiddenInput(['value' => $model->id_resume_medis_rj])->label(false) ?>
                                 ...
                                 <div class="row">
                                     <div class="col-md-12">
                                         <?php DynamicFormWidget::begin([
                                                ...
                                                'model' => $modelsIcd9[0],
                                                'formId' => 'codingclaimic9-' . $modelCustomer->formName(),
                                                'formFields' => [
                                                    'id',
                                                    'icd9_id',
