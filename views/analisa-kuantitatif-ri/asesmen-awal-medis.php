...
<table class="table table-sm table-form" style="border: 1px solid;">
	...
	<tr>
        ...
        <td colspan="10"><?=($asesmen->riwayat_pengobatan??'-')?></td>
    </tr>
    <tr>
	...
	<tr>
        <th class="text-left bg-lightblue" colspan="12" style="text-align:left">C. PEMERIKSAAN FISIK</th>
    </tr>
    <tr>
        <td colspan="2"><b>Kepala :</b></td>
        <td colspan="10"><?=($asesmen->kepala??'-')?></td>
    </tr>
    <tr>
    ...
    <tr><th class="text-left bg-lightblue" colspan="12" style="text-align:left">E. STATUS LOKALIS</th></tr>
    <tr>
        <td colspan="12"><?=($asesmen->status_lokalis??'-')?></td>
    </tr>
    <tr><th class="text-left bg-lightblue" colspan="12" style="text-align:left">F. PEMERIKSAAN PENUNJANG</th></tr>
    <tr>
        <td colspan="12">
        <?=($asesmen->pemeriksaan_penunjang??'-')?>
        </td>
    </tr>
    <tr><th class="text-left bg-lightblue" colspan="12" style="text-align:left">G. MASALAH</th></tr>
    <tr>
        <td colspan="12">
        <?=($asesmen->masalah??'-')?>
        </td>
    </tr>
    <tr><th class="text-left bg-lightblue" colspan="12" style="text-align:left">H. PENATALAKSANAAN</th></tr>
    <tr>
        <td colspan="12">
        <?=($asesmen->penatalaksanaan??'-')?>
        </td>
    </tr>
    <tr><th class="text-left bg-lightblue" colspan="12" style="text-align:left">I. PEMERIKSAAN LANJUTAN</th></tr>
    <tr>
        <td colspan="12">
        <?=($asesmen->pemeriksaan_ulang??'-')?>
        </td>
    </tr>
    <tr><th class="text-left bg-lightblue" colspan="12" style="text-align:left">G. RENCANA ASUHAN</th></tr>
    <tr>
    <td colspan="6">
        <b>Status Keluar : </b> <?=($asesmen->status_keluar??'-')?>
        </td>
     
        <td colspan="6">
        <b>Keterangan Keluar : </b> <?=($asesmen->keterangan_keluar??'-')?>
        </td>
