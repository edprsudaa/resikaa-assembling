...
<table class="table table-sm table-form" style="border: 2px solid;">
    ...
    <tr>
        ...
        <td colspan="10"><?=($asesmen->imunisasi??'-')?></td>
    </tr>
    <tr>
    ...
    <tr>
        <th class="text-left bg-lightblue" colspan="12" style="text-align:left">B. RIWAYAT PERKAWINAN</th>
    </tr>
    <tr>
    ...
    <tr>
        <th class="text-left bg-lightblue" colspan="12" style="text-align:left">C. RIWAYAT HAID</th>
    </tr>
    <tr>
    ...
    <tr>
        <th class="text-left bg-lightblue" colspan="12" style="text-align:left">B. RIWAYAT KEHAMILAN,PERSALINAN DAN NIFAS YANG LALU</th>
    </tr>
    <tr>
        <td><b>No</b></td>
        <td><b>Tgl/Thn</b></td>
    ...
    <tr>
        <td><?=($asesmen->riwayat_perkawinan_usia_kawin_thn??'-')?></td>
        <td><?=($asesmen->riwayat_perkawinan_usia_kawin_thn??'-')?></td>
        <td><?=($asesmen->riwayat_perkawinan_usia_kawin_thn??'-')?></td>
        <td><?=($asesmen->riwayat_perkawinan_usia_kawin_thn??'-')?></td>
        <td><?=($asesmen->riwayat_perkawinan_usia_kawin_thn??'-')?></td>
    ...
    <tr>
        <th class="text-left bg-lightblue" colspan="12" style="text-align:left">B. RIWAYAT KEHAMILAN INI</th>
    </tr>
    <tr>
        <td><b>G :</b></td>
        <td><b>P :</b></td>
    ...
    <tr>
        <th class="text-left bg-lightblue" colspan="12" style="text-align:left">B. RIWAYAT PERSALINAN SEKARANG</th>
    </tr>
    <tr>
    ...
    <tr>
        <th class="text-left bg-lightblue" colspan="12" style="text-align:left">B. RIWAYAT BERHUBUNGAN DENGAN MASALAH KESEHAN REPRODUKSI</th>
    </tr>
    <tr>
    ...
    <tr>
        <th class="text-left bg-lightblue" colspan="12" style="text-align:left">B. RIWAYAT KELUARGA BERENCANA</th>
    </tr>
    <tr>
    ...
    <tr>
        <th class="text-left bg-lightblue" colspan="12" style="text-align:left">B. PEMERIKSAAN TANDA VITAL</th>
    </tr>
    <tr>
    ...
    <tr>
        <th class="text-left bg-lightblue" colspan="6" style="text-align:left">K. PEMERIKSAAN FISIK LAINNYA</th>
        <th class="text-left bg-lightblue" colspan="6" style="text-align:left">L. PEMERIKSAAN DALAM</th>
    </tr>
    <tr>
    ...
    <tr>
        <th class="text-left bg-lightblue" colspan="12" style="text-align:left">O. HAL-HAL YANG MASIH PERLU DIKAJI(TETAPI TIDAK TERCANTUM DALAM FORMAT)</th>
    </tr>
    <tr>
        <td colspan="12"><?=($asesmen->hal_hal_lain??'-')?></td>
    </tr>
    <tr>
        <th class="text-left bg-lightblue" colspan="12" style="text-align:left">O. KESIMPULAN/DIAGNOSA ATAU MASALAH</th>
    </tr>
    <tr>
        <td colspan="12"><?=($asesmen->kesimpulan??'-')?></td>
    </tr>
    <tr>
        <th class="text-left bg-lightblue" colspan="12" style="text-align:left">O. PENATALAKSANAAN</th>
    </tr>
    <tr>
