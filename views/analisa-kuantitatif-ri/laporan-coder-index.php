                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <?php $form = ActiveForm::begin([
                                'action' => ['/analisa-kuantitatif/cetak-laporan-coder'],
                                'options' => [
                                    'target' => 'blank',
                                ],
                                'id' => 'form-laporan',
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <?php
                                    echo $form->field($modelLaporanCoder, 'jenis_laporan', ['options' => ['required' => 'required']])->inline()->radioList(
                                        [
                                            'harian' => 'Harian',
                                            'bulanan' => 'Bulanan',
                                            'tahunan' => 'Tahunan',
                                        ...
                                        [
                                            'item' => static function ($index, $label, $name, $checked, $value) use ($modelLaporanCoder) {
                                                return Helper::radioList($index, $label, $name, $checked, $value, $modelLaporanCoder);
                                            }
                                        ]
                                    )->label('Jenis Laporan');
                                    ?>
                                    <?php
                                    echo $form->field($modelLaporanCoder, 'tipe_laporan')->inline()->radioList(
                                        [
                                            'seluruh' => 'Seluruh',
                                    ...
                                    echo $form->field($modelLaporanCoder, 'tgl_hari', [
                                    ...
                                    echo $form->field($modelLaporanCoder, 'tgl_bulan', [
                                        'wrapperOptions' => ['style' => 'margin-left: 0px;'],
                                    ])->widget(DatePicker::classname(), [
                                        'options' => ['placeholder' => 'Pilih...'],
                                        'removeButton' => false,
                                    ...
                                    echo $form->field($modelLaporanCoder, 'tgl_tahun', [
                                        'wrapperOptions' => ['style' => 'margin-left: 0px;'],
                                    ])->widget(DatePicker::classname(), [
                                        'options' => ['placeholder' => 'Pilih...'],
                                        'removeButton' => false,
                                    ...
                                    ?>
                                    <?php
                                    echo '<div id="div-analisa-dokumen-coder_id" style="display: none;">';
                                    echo $form->field($model, 'coder_id')->widget(Select2::classname(), [
                                        'data' => HelperSpesialClass::getListCoder(),
                                        'size' => 'xs',
                                        'options' => ['class' => 'form-control input-sm', 'placeholder' => 'Pilih Poli Tujuan...'],
                                        'value' => $model->coder_id,
                                        'pluginOptions' => [
                                            'allowClear' => true,
                                        ],
...
<?php
$this->registerJs($this->render('laporan-coder-index.js'), View::POS_END);
