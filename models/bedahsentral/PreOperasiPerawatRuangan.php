...
class PreOperasiPerawatRuangan extends \yii\db\ActiveRecord
{
  ...
  function setBatal()
  {
    $this->pop_batal_ruangan = 1;
    $this->pop_tgl_batal = date('Y-m-d H:i:s');
  }
  function setFinal()
  {
    $this->pop_final_ruangan = 1;
  ...
  function getPerawat()
  {
    return $this->hasOne(TbPegawai::className(), ['pegawai_id' => 'pop_pgw_id_ruangan']);
  }
}
