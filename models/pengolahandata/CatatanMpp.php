...
/**
 * This is the model class for table "catatan_mpp".
 *
 * @property int $id
 ...
 * @property int|null $lengkap
 
 */
class CatatanMpp extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'pengolahan_data.catatan_mpp';
    }
    ...
    {
        $CatatanMppReq = Yii::$app->request->post('CatatanMpp');
