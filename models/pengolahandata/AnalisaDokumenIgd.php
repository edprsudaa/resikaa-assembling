 ...
 */
class AnalisaDokumenIgd extends \yii\db\ActiveRecord
{
    ...
    {
        return 'pengolahan_data.analisa_dokumen_igd';
    }
    ...
    function saveData()
    {
        $analisaDokumenReq = Yii::$app->request->post('AnalisaDokumenIgd');
        $analisaDokumenReqDetail = Yii::$app->request->post('AnalisaDokumenIgdDetail');
        ...
        try {
            if (Yii::$app->request->post('analisa_dokumen_id')) {
                $analisaDokumen = AnalisaDokumenIgd::find()->where(['analisa_dokumen_id' => Yii::$app->request->post('analisa_dokumen_id')])->one();
                ...
                if ($analisaDokumen->save()) {
                    foreach ($analisaDokumenReqDetail as $k) {
                        $data = AnalisaDokumenIgdDetail::find()->where([
                ...
                foreach ($analisaDokumenReqDetail as $k) {
                    ...
                    $data = new AnalisaDokumenIgdDetail();
                    $data->analisa_dokumen_id = $this->analisa_dokumen_id;
                    $data->analisa_dokumen_jenis_analisa_detail_id = $k['analisa_dokumen_jenis_analisa_detail_id'];
    ...
    function getAnalisaDokumenIgdDetail()
    {
        return $this->hasMany(AnalisaDokumenIgdDetail::className(), ['analisa_dokumen_id' => 'analisa_dokumen_id']);
    }
}
