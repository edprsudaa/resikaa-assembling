...
/**
 * This is the model class for table "coding_pelaporan_tindakan_detail_ri".
 *
 * @property int $id
 ...
 */
class CodingPelaporanTindakanDetailRi extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'coding_pelaporan_tindakan_detail_ri';
    }
