 ...
 */
class CodingPelaporanRj extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'pengolahan_data.coding_pelaporan_rj';
    }
    ...
    public function rules()
    {
        return [
            ...
            [['jenis_layanan', 'pegawai_coder_id', 'id_resume_medis_rj', 'created_by', 'updated_by', 'deleted_by', 'kasus'], 'integer'],
            [['keterangan'], 'string'],
            [['estimasi'], 'number'],
    ...
    {
        return $this->hasMany(CodingPelaporanDiagnosaDetailRj::className(), ['coding_pelaporan_id' => 'id']);
    }
    function getPelaporanTindakan()
    {
        return $this->hasMany(CodingPelaporanTindakanDetailRj::className(), ['coding_pelaporan_id' => 'id']);
    }
