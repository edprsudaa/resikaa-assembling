 ...
 */
class CodingPelaporanIgd extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'pengolahan_data.coding_pelaporan_igd';
    }
    ...
    public function rules()
    {
        return [
            ...
            [['jenis_layanan', 'pegawai_coder_id', 'id_ringkasan_pulang_igd', 'created_by', 'updated_by', 'deleted_by', 'kasus'], 'integer'],
            [['keterangan'], 'string'],
            [['estimasi'], 'number'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'id_ringkasan_pulang_igd' => 'Ringkasan pulang IGD',
    ...
    {
        return $this->hasMany(CodingPelaporanDiagnosaDetailIgd::className(), ['coding_pelaporan_id' => 'id']);
    }
    function getPelaporanTindakan()
    {
        return $this->hasMany(CodingPelaporanTindakanDetailIgd::className(), ['coding_pelaporan_id' => 'id']);
    }
