...
/**
 * This is the model class for table "coding_pelaporan_tindakan_detail_rj".
 *
 * @property int $id
 ...
 */
class CodingClaimTindakanDetailIgd extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'coding_claim_tindakan_detail_igd';
    }
    ...
    {
        return $this->hasOne(CodingClaimIgd::className(), ['id' => 'coding_pelaporan_id']);
    }
}
