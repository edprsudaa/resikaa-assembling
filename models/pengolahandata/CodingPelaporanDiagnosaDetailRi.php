...
/**
 * This is the model class for table "coding_pelaporan_diagnosa_detail_ri".
 *
 * @property int $id
 ...
 */
class CodingPelaporanDiagnosaDetailRi extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'coding_pelaporan_diagnosa_detail_ri';
    }
