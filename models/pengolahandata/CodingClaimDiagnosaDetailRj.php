 ...
 */
class CodingClaimDiagnosaDetailRj extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'coding_claim_diagnosa_detail_rj';
    }
    ...
    {
        return $this->hasOne(CodingClaimRj::className(), ['id' => 'coding_pelaporan_id']);
    }
}
