...
/**
 * This is the model class for table "coding_pelaporan_tindakan_detail".
 *
 * @property int $id
 ...
 */
class CodingPelaporanTindakanDetail extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'coding_pelaporan_tindakan_detail';
    }
    ...
    {
        return [
            // [['coding_pelaporan_id', 'utama', 'icd9_id', 'created_by'], 'required'],
