 ...
 */
class CodingClaim extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'pengolahan_data.coding_claim';
    }
    ...
    public function rules()
    {
        return [
            ...
            [['jenis_layanan', 'pegawai_coder_id', 'id_resume_medis_ri', 'created_by', 'updated_by', 'deleted_by', 'kasus', 'diagnosa_simpan', 'tindakan_simpan'], 'integer'],
            [['keterangan'], 'string'],
            [['estimasi'], 'number'],
    ...
    {
        return $this->hasMany(CodingClaimDiagnosaDetail::className(), ['coding_claim_id' => 'id']);
    }
    function getClaimTindakan()
    {
        return $this->hasMany(CodingClaimTindakanDetail::className(), ['coding_claim_id' => 'id']);
    }
