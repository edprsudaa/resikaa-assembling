...
class AnalisaKuantitatifRiController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    public function actionDaftarAnalisaKuantitatif()
    {
        ...
        $layanan = Layanan::find()->alias('l')
            ...
            ->where([">=", "r.tgl_keluar", $tanggal_awal . " 00:00:00"])
            ->andWhere(["<=", "r.tgl_keluar", $tanggal_akhir . " 23:59:59"])
            ->andWhere(["r.deleted_at" => null])
            ->andWhere(['not in', 'l.jenis_layanan', '2'])
            ->andWhere(['not', ['r.tgl_keluar' => null]]);
    ...
    public function actionView($id = null, $icd = false)
    {
        ...
        $listAnalisa = MasterJenisAnalisaDetail::find()->innerJoinWith(['jenisAnalisa', 'itemAnalisa'])->where(['jenis_analisa_detail_aktif' => 1])->andWhere(['jenis_analisa_detail_ri' => 1])->orderBy(['jenis_analisa_detail_jenis_analisa_id' => SORT_ASC, 'jenis_analisa_detail_item_analisa_id' => SORT_ASC])->asArray()->all();
